...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "حسيم — برنامج محاسبة وفوترة إلكترونية" },
      { name: "description", content: "لوحة تحكم مالية بسيطة: مبيعات، مشتريات، نقد وبنوك، وتقارير." },
      { property: "og:title", content: "حسيم — لوحة المعلومات" },
      { property: "og:description", content: "برنامج محاسبة وفوترة إلكترونية بدون تعقيد." },
